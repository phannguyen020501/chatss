...
import com.example.chatss.databinding.ActivityDeleteMemberBinding;
...
public class DeleteMemberActivity extends AppCompatActivity implements UserListener {
    private ActivityDeleteMemberBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDeleteMemberBinding.inflate(getLayoutInflater());
