...
public class Test {
    ...
    private static void savePrivateKeyToKeystore(PrivateKey privateKey, String KEY_NAME) throws Exception {
        KeyStore keyStore = KeyStore.getInstance("AndroidKeyStore");
        keyStore.load(null);
        KeyStore.PrivateKeyEntry privateKeyEntry = new KeyStore.PrivateKeyEntry(privateKey, null);
        keyStore.setEntry(KEY_NAME, privateKeyEntry, null);
    }

    private static PrivateKey getPrivateKeyFromKeystore(String KEY_NAME) throws Exception {
        KeyStore keyStore = KeyStore.getInstance("AndroidKeyStore");
        keyStore.load(null);
